...
<a href="https://wa.me/918329242513"
 target="_blank"
 class="fixed bottom-6 right-6 w-14 h-14 sm:w-16 sm:h-16 bg-green-500 rounded-full flex items-center justify-center text-white text-2xl sm:text-3xl shadow-2xl z-50 hover:scale-110 transition duration-300">
